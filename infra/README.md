...
|----------|------|-------|-------|
| **Hetzner** | [`hetzner/`](hetzner/) | Single VM + Docker Compose release stack. Cheap eval / small-team tier — no HA, no DR. | [docs/getting-started/deploy-hetzner.md](../docs/getting-started/deploy-hetzner.md) |
