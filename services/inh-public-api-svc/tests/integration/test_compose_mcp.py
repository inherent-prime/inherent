...
# a live test and forces a human to re-confirm the published surface -- 19
# tools on stdio, 15 of them exposed on HTTP (#220's "10, not 13" base, plus
# report_feedback, plus whoami from #278 and list_workspaces from #297, plus
# chunk CRUD create/edit/delete from #133). If a diff to these lists is
